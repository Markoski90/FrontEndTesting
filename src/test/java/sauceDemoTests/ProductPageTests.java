...
public class ProductPageTests {
    ...
    public void addToCartButton() {
        productsPage.clickAddBackpackToCartButton();
        boolean isShoppingCartDisplayed = driver.findElement(productsPage.shoppingCartBadge).isDisplayed();
    ...
    public void addTwoItemsOnShoppingCart() {
        ...
        String cartItemCountText = driver.findElement(productsPage.shoppingCartBadge).getText();
        int cartItemCount = Integer.parseInt(cartItemCountText);
    ...
    public void burgerMenuButtonTest() {
        ...
        assertFalse(productsPage.isCrossMenuButtonDisplayed());
    }
